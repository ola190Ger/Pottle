...
// Основные настройки:
$recipients = ['ola190.ger@gmail.com']; // Получатели писем
...
$smtp_username = 'ola190.ger@gmail.com'; // Почтовый ящик, с которого будут отправляться письма
$smtp_password = 'Cfvjrjynhjkm2018'; // Пароль почтового ящика, с которого будут отправляться письма
